...
public class UserLastYearSales extends AppCompatActivity {
    BarChart chart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<MonthlyReportModel> monthlyReportModels = (ArrayList<MonthlyReportModel>) extras.getSerializable(ReportActivity.KEY_USER_GRAPH);
        ...
        chart.setData(data);
        chart.setDescription("My Last Year Sales");
