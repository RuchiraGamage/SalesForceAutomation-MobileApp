...
public class PreOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewTouchListener(getActivity(), recyclerView, new RecyclerViewClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                alert.inputDialogAlert(adepter.getProductByPosition(position), BillingTabViewActivity.KEY_PREORDER);
            }
    ...
    private void fetchProduct(){
        if(new ConnectionDetector(getActivity()).isConnected()){
            ...
            try{
                adepter = new ProductAdapter(getActivity(), new SQLiteProductHandler(getActivity()).getAllProduct());
                recyclerView.setAdapter(adepter);
            }catch (Exception e){
