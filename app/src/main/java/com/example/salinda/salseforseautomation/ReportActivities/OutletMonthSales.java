...
public class OutletMonthSales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outletId = extras.getInt(ReportOutletSelectorAdaptor.KEY_OUTLETID);
        outletName = extras.getString(ReportOutletSelectorAdaptor.KEY_OUTLET_NAME);
        ...
        getSupportActionBar().setTitle(outletName+" "+selectedMonth+" Sales");
    ...
    private void fetchData(){
        ...
        if(new ConnectionDetector(this).isConnected()){
            ...
            Call<List<MonthReportModel>> call = apiInterface.getOutletMonthSales(outletId, month, year);
